/-
ATTRIBUTION: copied verbatim on 2026-07-06 from the OPH team's repository
  observer-patch-holography/LEAN/ObserverPatchHolography/AbstractRewriting.lean
  (same pinned toolchain/Mathlib revision). No changes except this header.
  Namespace `OPH.AbstractRewriting` kept so the file matches its source 1:1.
-/
import Mathlib
